...
const PROMPT = [
  ...
  '  "date": "<วันที่ในเอกสาร รูปแบบ DD/MM/YYYY เท่านั้น เช่น 24/07/2569 (ปีพ.ศ.คงไว้) ถ้าอ่านไม่ชัดให้ null>",',
  '  "doc_time": "<เวลาในเอกสาร รูปแบบ HH:MM ถ้ามี>",',
  ...
  'กติกาเรื่องวันที่ (สำคัญมาก): อ่านวันที่ทีละหลักอย่างระวัง เช่น "24072569" คือ 24/07/2569, ห้ามเดา ถ้าไม่ชัดให้ null',
...
export function parseResult(content) {
  ...
  return {
    ...
    docTime: strOrNull(parsed.doc_time),
